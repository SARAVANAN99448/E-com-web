    ...
    return (<>
        ...
        <section className="md:hidden">
            ...
            <div className="flex justify-center pt-10 relative" >
                ...
                <p className="px-20 text-white absolute top-[240px]" style={{fontSize:"10px"}}>"Become the King of Pirates with Epic One Piece Gear!
                        Discover treasures from the Grand Line. Shop exclusive One Piece merchandise now!"</p>
<div className="flex justify-center ">
<button style={{fontSize:"10px"}} className="absolute font-bold top-[275px] le hover:bg-blue-800 bg-blue-600 p-2 rounded-md text-white"><Link to={"/products"}>Show now</Link></button>
