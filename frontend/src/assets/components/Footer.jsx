...
const Footer = () => {
    ...
    return (<>
        <footer>
            <hr />
            <div className="bg-pink-400 flex justify-center  pb-5 text-white text-center pt-10 md:text-xl font-hero-font">
            ...
            <div className="bg-pink-400 text-center text-white  font-hero-font ">
                <p>&copy;saravanan</p>
            </div>
        </footer>
    </>)
